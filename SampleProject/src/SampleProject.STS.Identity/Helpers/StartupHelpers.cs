...
using SampleProject.STS.Identity.Configuration.ApplicationParts;
using SampleProject.STS.Identity.Configuration.Constants;
using SampleProject.STS.Identity.Configuration.Interfaces;
using SampleProject.STS.Identity.Helpers.Localization;

namespace SampleProject.STS.Identity.Helpers
{
