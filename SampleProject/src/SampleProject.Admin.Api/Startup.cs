...
using SampleProject.Admin.Api.Configuration;
using SampleProject.Admin.Api.Configuration.Authorization;
using SampleProject.Admin.Api.Configuration.Constants;
using SampleProject.Admin.Api.ExceptionHandling;
using SampleProject.Admin.Api.Helpers;
using SampleProject.Admin.Api.Mappers;
using SampleProject.Admin.Api.Resources;
...
using SampleProject.Admin.EntityFramework.Shared.DbContexts;
using SampleProject.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.Duende.IdentityServer.Shared.Configuration.Helpers;
using SampleProject.Shared.Dtos;
using SampleProject.Shared.Dtos.Identity;

namespace SampleProject.Admin.Api
{
